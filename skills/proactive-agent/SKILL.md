...
read_when:
  - User starts a long-running project or complex task
  - User mentions "proactive", "self-improve", "anticipate", "active mode", "主动模式"
  - Agent detects a situation requiring continuous background monitoring or planning
---
