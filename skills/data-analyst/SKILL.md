...
author: openclaw
read_when:
  - User wants to analyze data, CSV files, or Excel spreadsheets.
  - User asks for data visualization, charts, or reports.
  - User mentions "数据分析", "数据可视化", "SQL查询", "CSV分析", "表格分析", "生成图表".
---
